<%-- 
    Document   : resultControlStructure
    Created on : Apr 9, 2020, 6:15:36 PM
    Author     : MAC
--%>
...
<html>
    <head>
        ...
        <title>Result Control Structure </title>
     ...
     <table id="dtBasicExample" class="table table-striped table-bordered table-sm">
                <thead>
                    <tr class="p-3 mb-2 bg-primary text-white">
                        ...
                        <th scope="col"> ProgramStatements</th>
	...
	<tbody>
     ...
     <div class="row">
          ...
          <div class="btn1">
           <div class="bt"><a href=control.jsp><button class="btn btn-primary" type="submit" data-toggle="modal" data-target="#exampleModalCenter"> Back</button></div>
  		</div>
