...
public class LineCoupling {
	
	private CustomFileCoupling file;
	...
	public LineCoupling(int lineNumber, String lineContent) {
	...
	public CustomFileCoupling getFile() {
		return file;
	}

	public void setFile(CustomFileCoupling file) {
		this.file = file;
	}
