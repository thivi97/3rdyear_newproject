		...
		try {
			...
			while (it.hasNext()) {
				...
				if (isFormField) {
					...
					String destination="C:\\Users\\MAC\\Desktop\\Vajira\\ControlStructure\\uploads"+fileItem.getName();
			...
			out.println("window.location.href='resultControlStructure.jsp?filename=" + file_name + "'");
			out.println("</script>");
			out.close();
		}
	}
